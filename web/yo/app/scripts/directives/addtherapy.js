            ...
            controller: function ($scope) {
                ...
                getDrugList().then(function () {
                    if ($scope.modifyMode === true) {
                        clearData();
                        initTherapy($scope.treatmentRef.name);
                    } else {
                        clearData();
                    }
                });
                ...
                $scope.save = function () {
                    ...
                    if (isValidTreatment(indices, newTreatmentName)) {
                        ...
                        if ($scope.modifyMode === true) {
                            ...
                            $scope.changeMapByCurator('name', 'treatment', $scope.path, name_uuid, newTreatmentName, oldContent);
