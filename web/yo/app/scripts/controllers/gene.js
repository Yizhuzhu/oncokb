    ...
    .controller('GeneCtrl', ['_', 'S', '$resource', '$interval', '$timeout', '$scope', '$rootScope', '$location', '$route', '$routeParams', '$window', '$q', 'dialogs', 'OncoKB', 'DatabaseConnector', 'SecretEmptyKey', '$sce', 'jspdf', 'FindRegex', 'mainUtils', 'ReviewResource', 'loadFiles', '$firebaseObject', '$firebaseArray', 'FirebaseModel', 'firebaseConnector', 'user', 'numOfReviewItems', 'checkNameChange',
        function (_, S, $resource, $interval, $timeout, $scope, $rootScope, $location, $route, $routeParams, $window, $q, dialogs, OncoKB, DatabaseConnector, SecretEmptyKey, $sce, jspdf, FindRegex, mainUtils, ReviewResource, loadFiles, $firebaseObject, $firebaseArray, FirebaseModel, firebaseConnector, user, numOfReviewItems, checkNameChange) {
            ...
            * */
            ...
            function findDrugUuid(name){
                ...
                switch (name){
                    ...
                    case 'Radioiodine Uptake Therapy':
                        //result = 'C74052';
                        result = fromNCIToUuid('C74052');
                        //console.log(result);
                        //result = '3a5810e6-6be4-49db-9629-ee02cbceb52f';
                        break;

                    case 'RG7112':
                        //result = 'C91724';
                        //result = '0ade496c-77e6-45cd-8e96-7c7d87b4e5de';
                        result = fromNCIToUuid('C91724');
                        console.log(result);
                        break;

                    case 'GSK343':
                        //result = 'C156804';
                        //result = 'a3f4c47b-f0ff-453c-be0f-dd4f7ea08681';
                        result = fromNCIToUuid('C156804');
                        console.log(result);
                        break;

                    case 'intensive chemotherapy':
                        //result = 'C15807';
                        //result = 'faef6994-b7f8-4845-9f10-8eab19d7cb86';
                        result = fromNCIToUuid('C15807');
                        console.log(result);
                        break;

                    case 'TKI216':
                        //result = 'C125657';
                        //result = 'af85c77d-1ae7-4dc5-a4a1-ccc7df58f0a6';
                        result = fromNCIToUuid('C125657');
                        console.log(result);
                        break;

                    case 'Ado-Trastuzumab Emtansine (T-DM1)':
                        //result = 'C82492';
                        //result ='598e7b9f-976d-46bc-aea7-42f1005db988';
                        result = fromNCIToUuid('C82492');
                        console.log(result);
                        break;

                    case 'High dose daunorubicin':
                        //result = 'C62091';
                        //result = '9ac8df57-d9dd-42db-9f8f-faddcdfc2861';
                        result = fromNCIToUuid('C62091');
                        console.log(result);
                        break;

                    case 'Omacetaxine':
                        //result = 'C1127';
                        //result = 'ab7baa7b-bc48-4496-ad56-103a7cfca889';
                        result = fromNCIToUuid('C1127');
                        console.log(result);
                        break;
                    ...
                    case 'Allogeneic Hematopoietic Cell Transplantation (HCT)':
                        //result = 'C46089';
                        //result = '2b0d3b74-04ec-4906-a1a8-07433e682e6d';
                        result = fromNCIToUuid('C46089');
                        console.log(result);
                        break;
            ...
            function fromNCIToUuid(code){
                var result = '';
                _.each(mainUtils.getKeysWithoutFirebasePrefix($scope.drugList), id =>{
                   if($scope.drugList[id].ncitCode == code){
                       result = $scope.drugList[id].uuid;
                       return;
                   }
               })
                return result;
